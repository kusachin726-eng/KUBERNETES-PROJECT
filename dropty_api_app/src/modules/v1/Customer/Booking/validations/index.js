...
const { pnrDetailsSchema, bookingSchema, bookingAddressSchema, timeSlotValidationSchema, confirmBookingValidationSchema, confirmBookingValidSchema, cancelBookingSchema } = require("./schema");
...
module.exports = {
  ...
  cancelBookingValidation: validate({ body: cancelBookingSchema })
};